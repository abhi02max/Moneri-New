    ...
    <>
      <section className="hero">
        <video className="hero-video" autoPlay loop muted playsInline poster="fallback-image.jpg">
          <source src='spavideo.mp4' type="video/mp4" />
        </video>
        ...
        <div className="container">
            ...
            <div className="feature-grid">
                <div className="content-card reveal" style={{transitionDelay: '0s'}}>
                    <div className="card-image-wrapper"><img src='first.jpg' alt="Hair Treatment"/></div>
                ...
                <div className="content-card reveal" style={{transitionDelay: '0.2s'}}>
                    <div className="card-image-wrapper"><img src="middle.jpg" alt="Skin Treatment"/></div>
                    <div className="card-content">
                ...
                <div className="content-card reveal" style={{transitionDelay: '0.4s'}}>
                    <div className="card-image-wrapper"><img src="/third.jpg" alt="Massage Therapy"/></div>
                    <div className="card-content">
        ...
        <div className="container">
          <div className="philosophy-content">
            ...
            <div className="philosophy-image reveal">
              <img src="salon.jpg" alt="Calm spa interior" />
            </div>
          </div>
        </div>
      </div>
